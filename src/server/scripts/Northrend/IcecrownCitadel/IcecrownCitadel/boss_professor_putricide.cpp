    ...
    public:
        ...
        struct boss_professor_putricideAI : public BossAI
        {
            ...
            void JustDied(Unit* /*pKiller*/)
            {
                ...
                instance->DoRemoveAurasDueToSpellOnPlayers(SPELL_GASEOUS_BLOAT_HELPER);
            }
            ...
            void JustSummoned(Creature* summon)
            {
                ...
                switch(summon->GetEntry())
                {
                    ...
                    case NPC_GAS_CLOUD:
                        ...
                        summon->ApplySpellImmune(0, IMMUNITY_ID, 49576, true);
                        summon->ApplySpellImmune(0, IMMUNITY_ID, 49560, true);
        ...
        {
            return GetIcecrownCitadelAI<boss_professor_putricideAI>(pCreature);
        }
};
...
class npc_volatile_ooze : public CreatureScript
{
    public:
        ...
        struct npc_volatile_oozeAI : public ScriptedAI
        {
            ...
            void SpellHitTarget(Unit* /*pTarget*/, SpellEntry const* spell)
            {
        ...
        CreatureAI* GetAI(Creature* pCreature) const
        {
            return GetIcecrownCitadelAI<npc_volatile_oozeAI>(pCreature);
        }
};
