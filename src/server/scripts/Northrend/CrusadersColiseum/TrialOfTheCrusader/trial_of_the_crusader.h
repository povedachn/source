...
const Position ToCCommonLoc[]=
{
    ...
    {577.178223f, 180.873230f, 395.138062f, 4.66f},     //  3 - Right
    {550.413635f, 178.092926f, 395.138031f, 4.68f},     //  4 - Left
    {563.565918f, 153.296082f, 394.32f, 4.71f}, //  5 - Center
    ...
    {563.92f, 186.48f, 394.49f, 4.75f},                // 10 Behind the door
