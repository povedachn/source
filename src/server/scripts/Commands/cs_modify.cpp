...
public:
    ...
    ChatCommand* GetCommands() const
    {
        static ChatCommand modifyCommandTable[] =
        {
			...
			{ "Unmount",        SEC_MODERATOR,      false, &HandleModifyUnmountCommand,       "", NULL },
    ...
    static bool HandleModifyASpeedCommand(ChatHandler* handler, const char* args)
    {
		...
		target->SetSpeed(MOVE_RUN_BACK, ASpeed, true);
        return true;
    }
    ...
    static bool HandleModifyMountCommand(ChatHandler* handler, const char* args)
    {
        ...
        switch(num)
        {
			...
			case 100: mId =	28871; break;
			case 101: mId =	19252; break;
			case 102: mId =	24939; break;
			case 103: mId =	24931; break;
			case 104: mId =	24377; break;
			case 105: mId =	24954; break;
			case 106: mId =	25015; break;
			case 107: mId =	9445;  break;
			case 108: mId =	8312;  break;
			case 109: mId =	1913;  break;
			case 110: mId =	8797;  break;
			case 111: mId =	709;   break;
			case 112: mId =	27797; break;
			case 113: mId =	27789; break;
			case 114: mId =	27688; break;
			case 115: mId =	27682; break;
			case 116: mId =	27567; break;
			case 117: mId =	2715;  break;
			case 118: mId =	27482; break;
			case 119: mId =	27218; break;
			case 120: mId =	27103; break;
            default:
...
*/
	...
	static bool HandleModifyUnmountCommand(ChatHandler* handler, const char* args)
	{
	    if(!*args)
			return false;
