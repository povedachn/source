...
class Unit : public WorldObject
{
    public:
        ...
        // player or player's pet resilience (-1%)
        //Custom
        uint32 GetMeleeWarriorCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_MELEE, 2.4f, 34.3f, damage); }
        uint32 GetSpellWarlockCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.4f, 33.0f, damage); }
        ...
        uint32 GetSpellCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.3f, 33.0f, damage); }

        // player or player's pet resilience (-1%), cap 100%
        //Custom
		uint32 GetMeleeWarriorDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_MELEE, 2.4f, 100.0f, damage); }
        ...
        uint32 GetSpellDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_CRIT_TAKEN_SPELL, 2.3f, 100.0f, damage); }
        ...
        void _AddAura(UnitAura* pAura, Unit* pCaster);
        ...
        bool isDestinationReachable(WorldObject *destObj) const;
