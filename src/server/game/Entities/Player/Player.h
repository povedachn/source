...
struct BGData
{
    ...
    uint32 bgInstanceID;                    ///< This variable is set to pBG->m_InstanceID,
...
public:
    ...
    public:
		...
		//Custom
		static uint32 GetAreaIdFromDB(uint64 guid);
		...
		static void DeleteArenaSeasons(); //CUSTOM KHANX
        ...
        bool IsSpellAffectedByMixology(SpellEntry const *spell) const;
    ...
    public:
        ...
        void Achievement3854Check()
        {
            if(HasAura(68502))
            {
                if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(3854))
                    CompletedAchievement(pAchievment);
            }
        }
        ...
        void Achievement3845() { T12059 = false; T11487 = false; T11488 = false; T11491 = false; }
        void Achievement3845Check()
        {
            if(T12059 == true && T11487 == true && T11488 == true && T11491 == true)
            {
                if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(3845))
                    CompletedAchievement(pAchievment);
            }
        }

        void Achievement1757Check()
        {
            if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(1757))
                CompletedAchievement(pAchievment);
        }

        void Achievement2200Check()
        {
            if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(2200))
                CompletedAchievement(pAchievment);
        }

        void Achievement1727Check()
        {
        ...
        void Achievement3848Check()
        {
            if(T12066 >= 5)
            {
                if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(3848))
                    CompletedAchievement(pAchievment);
            }
        }

        void Achievement409Check()
        {
            if(AchievementEntry const* pAchievment = GetAchievementStore()->LookupEntry(409))
                CompletedAchievement(pAchievment);
        }
};

void AddItemsSetItem(Player* player, Item *item);
void RemoveItemsSetItem(Player* player, ItemTemplate const* pItem);
