...
bool BattlegroundMap::Add(Player* player)
{
	...
	if (player->HasItemCount(37661, 1))
		player->DestroyItemCount(37661, -1, true, false);
	
	CharacterDatabase.PExecute("DELETE FROM racha WHERE guid='%u'", player->GetGUID());
	CharacterDatabase.PExecute("DELETE FROM racha_sanacion WHERE guid='%u'", player->GetGUID());
...
void BattlegroundMap::Remove(Player* player, bool remove)
{
	...
	// Limpieza al salir de la BG del rachas
	CharacterDatabase.PExecute("DELETE FROM racha WHERE guid='%u'", player->GetGUID());
	CharacterDatabase.PExecute("DELETE FROM racha_sanacion WHERE guid='%u'", player->GetGUID());
