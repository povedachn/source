...
class BattlegroundMgr
{
    ...
    public:
        ...
        void BuildPvpLogDataPacket(WorldPacket *data, Battleground* pBG);
        void BuildBattlegroundStatusPacket(WorldPacket *data, Battleground* pBG, uint8 QueueSlot, uint8 StatusID, uint32 Time1, uint32 Time2, uint8 arenatype, uint8 uiFrame = 1);
        void BuildPlaySoundPacket(WorldPacket *data, uint32 soundid);
        void SendAreaSpiritHealerQueryOpcode(Player* pl, Battleground* pBG, const uint64& guid);
