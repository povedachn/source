...
class BattlegroundQueue
{
    public:
        ...
        void FillPlayersToBG(Battleground* pBG, BattlegroundBracketId bracket_id);
        bool CheckPremadeMatch(BattlegroundBracketId bracket_id, uint32 MinPlayersPerTeam, uint32 MaxPlayersPerTeam);
        bool CheckNormalMatch(Battleground* pBG_template, BattlegroundBracketId bracket_id, uint32 minPlayers, uint32 maxPlayers);
    ...
    private:
        bool InviteGroupToBG(GroupQueueInfo * ginfo, Battleground* pBG, uint32 side);
