...
enum BattlegroundSpells
{
	...
	SPELL_ARENA_PREPARATION2 		= 32728,				// Para las spells instant en arenas
...
public:
    ...
    BattlegroundMap* GetBgMap()         { return m_Map; }
    ...
    virtual void EventPlayerClickedOnFlag(Player* /*pPlayer*/, GameObject* /*pGO*/) { }
    ...
    BGObjects BGArrayForObjects;
    BGCreatures BGArrayForCreatures;
...
private:
    // Battleground
	bool m_firstkill;									//Sistema de Primera Sangre
