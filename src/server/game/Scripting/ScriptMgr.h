...
class ItemScript : public ScriptObject
{
    ...
    public:
		...
		// Called when a player opens a gossip dialog with the item.
...
class AchievementCriteriaScript : public ScriptObject
{
    ...
    public:
        ...
        virtual bool OnCheck(Player* pSource, Unit* target) = 0;
};
...
class PlayerScript : public ScriptObject
{
    ...
    public:
		...
		//Custom
		virtual void OnPVPHeal(Player* /*healer*/, Unit* /*healed*/, uint32 /*healAmount*/) { }
        ...
        virtual void OnDuelRequest(Player* /*pTarget*/, Player* /*challenger*/) { }
...
class ScriptMgr
{
    ...
    public: /* AchievementCriteriaScript */
        ...
        bool OnCriteriaCheck(AchievementCriteriaData const* data, Player* pSource, Unit* target);
