...
ChatCommand * ChatHandler::getCommandTable()
{
    ...
    static ChatCommand serverCommandTable[] =
    {
        ...
        { "motd",           SEC_GAMEMASTER,     true,  OldHandler<&ChatHandler::HandleServerMotdCommand>,        "", NULL },
    ...
    static ChatCommand commandTable[] =
    {
        ...
        { "gameobject_template",         SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadGameobjectTemplateCommand>, "", NULL },
        { "item_template",               SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadItemTemplateCommand>,       "", NULL },
        { "creature_template",           SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadCreatureTemplateCommand>,   "", NULL },
        { "battleground_template",       SEC_ADMINISTRATOR, true,  OldHandler<&ChatHandler::HandleReloadBattlegroundTemplateCommand>,   "", NULL },
        // Finalizados comandos inestables
		//Empezar antes la bg
		{ "bgstart",       SEC_ADMINISTRATOR,  true,  OldHandler<&ChatHandler::HandleBGStartCommand>, "", NULL },
